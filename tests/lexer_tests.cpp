...
std::vector<Frizz::TokType> map_tokens_by_id(std::vector<Frizz::Token> tokens) {
	...
	for (std::vector<Frizz::Token>::iterator it = tokens.begin();
			it != tokens.end(); ++it) {
...
TEST_F(LexerTests, Complete) {
	...
	expected.push_back(std::vector<Frizz::TokType> { Frizz::TokType::tok_block,
			Frizz::TokType::tok_ident, Frizz::TokType::tok_sym,
	...
	expected.push_back(std::vector<Frizz::TokType> { Frizz::TokType::tok_sym,
			Frizz::TokType::tok_sym, Frizz::TokType::tok_ident,
			Frizz::TokType::tok_ident, Frizz::TokType::tok_ident,
			Frizz::TokType::tok_ident, Frizz::TokType::tok_ident,
			Frizz::TokType::tok_sym, Frizz::TokType::tok_sym });
	...
	expected.push_back(std::vector<Frizz::TokType> { Frizz::TokType::tok_block,
			Frizz::TokType::tok_ident, Frizz::TokType::tok_sym,
			Frizz::TokType::tok_str, Frizz::TokType::tok_ident,
			Frizz::TokType::tok_sym, Frizz::TokType::tok_ident });
